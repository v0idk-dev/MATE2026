...
OUTPUT_DIRECTORY = 'right_calibration_images'  # Directory to save calibration images
...
def capture_calibration_images():
    ...
    while True:
        ...
        # Crop bottom-right quadrant to match the spliced CCTV feed layout.
        h, w = frame.shape[:2]
        frame = frame[h // 2:, w // 2:].copy()
